    ...
    return (
        <div className="md:p-6 py-2 px-4 flex justify-between">
            ...
            <div className="flex items-center cursor-pointer" onClick={() => window.location.reload()}>
                ...
                <p className="md:text-xl text-white ml-2 font-['Space_Mono']">GraphicGate</p>
            </div>
            ...
            <div className="font-['Work_Sans'] text-white hidden md:flex items-center">
                ...
                {!props.loggedIn && <div>
                    <button onClick={() => setPage(Page.LOGIN_PAGE)} className="transition duration-500 ease-in-out bg-[black] rounded-lg px-4 py-1 ml-12 border-[#A259FF] border-2 hover:bg-transparent">Login</button>
                    <button onClick={() => setPage(Page.SIGNUP_PAGE)} className="transition duration-500 ease-in-out bg-[black] rounded-lg px-4 py-1 ml-6 border-[#A259FF] border-2 hover:bg-transparent">Sign Up</button>
                </div>}
